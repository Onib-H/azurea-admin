...
import com.harold.azureaadmin.ui.components.filters.FilterChipGroup
...
import com.harold.azureaadmin.ui.components.modals.ItemDetail
import com.harold.azureaadmin.ui.components.modals.ItemType
...
fun AreasScreen(
    ...
    var maxPrice by remember { mutableStateOf(1000000.0) }
                    ...
                    PullToRefreshBox(
                        ...
                        Box(modifier = Modifier.fillMaxSize()) {
                            when {
                                ...
                                error != null -> {
                                    ErrorState(error, { viewModel.fetchAreas() })
                                }
